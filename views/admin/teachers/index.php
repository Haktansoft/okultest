...
<div class="page-header">
  <div>
    ...
    <div class="page-sub">Hesapları sen oluşturursun; öğretmenler kendi öğrencilerini ekler. Giriş sadece şifre ile yapılır.</div>
  </div>
...
<div class="table-wrap">
  <table class="table">
    <thead><tr><th>Ad</th><th>Şifre</th><th class="text-end">Öğrenci</th><th>Durum</th><th></th></tr></thead>
    <tbody>
      <?php if (!$items): ?>
      ...
      <?php else: foreach ($items as $i): ?>
        <tr data-row-id="<?= (int)$i['id'] ?>">
          <td>
            ...
            <form class="name-edit-form d-none d-flex align-items-center gap-1" method="post" action="/admin/teachers/<?= (int)$i['id'] ?>/rename">
              <?= csrfField() ?>
